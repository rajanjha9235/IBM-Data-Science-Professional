...
#spacex_df = pd.read_csv("spacex_launch_dash.csv") # We can also use this but we need to download this csv file
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filtered_df=filtered_df.groupby(['Launch Site','class']
